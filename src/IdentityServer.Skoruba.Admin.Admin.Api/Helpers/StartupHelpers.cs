using IdentityModel;
using IdentityServer.Skoruba.Admin.Admin.Api.AuditLogging;
using IdentityServer.Skoruba.Admin.Admin.Api.Configuration;
using IdentityServer.Skoruba.Admin.Admin.Api.Configuration.ApplicationParts;
using IdentityServer.Skoruba.Admin.Admin.Api.Configuration.Constants;
using IdentityServer.Skoruba.Admin.Admin.Api.Helpers.Localization;
...
namespace IdentityServer.Skoruba.Admin.Admin.Api.Helpers
{
