...
using IdentityServer.Skoruba.Admin.STS.Identity.Configuration;
using IdentityServer.Skoruba.Admin.STS.Identity.Configuration.ApplicationParts;
using IdentityServer.Skoruba.Admin.STS.Identity.Configuration.Constants;
using IdentityServer.Skoruba.Admin.STS.Identity.Configuration.Interfaces;
using IdentityServer.Skoruba.Admin.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace IdentityServer.Skoruba.Admin.STS.Identity.Helpers
{
